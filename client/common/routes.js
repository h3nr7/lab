...
const outDayRoutes = () => {
  ...
  let container = [
    ...
    { name: 'Star',               image: null,  showInNavi: false,  obj: XmasTree,                  url: '/2016/test/star' },
    ...
    { name: 'Testing of Authagraph shapes', image: null,  showInNavi: true,   obj: ShapeTest,       url: '/2017/learning/shapetest' },
  ]
